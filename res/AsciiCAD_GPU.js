    ...
    this.computeHighlightOverlay = function(rects, rows, cols)
    {
        ...
        try
        {
            ...
            for (let i = 0; i < rectCount * 4; i++) rectBuf[i] = rects[i];
             ...
             // This is normal behavior. When calling with arguments, GPU kicks in (this.computeHighlightOverlay.kObject object is resides in the GPU, not accessible by CPU)
            return this.computeHighlightOverlay.kObject(rectBuf, rectCount); 
        }
