...
Notes: AsciiCAD does not replace the need for a real CAD program for electronic schema design, but when someone is downloading (e.g. Arduino) source code only, a simple embedded schematic can help to test this code very quickly on a breadboard.
