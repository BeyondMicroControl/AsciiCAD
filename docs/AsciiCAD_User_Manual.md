...
### 1) Open AsciiCAD
- Run the <a href="https://beyondmicrocontrol.github.io/AsciiCAD/index.html">hosted version on GitHub</a>, or <a href="https://beyondmicrocontrol.github.io/AsciiCAD/dist/AsciiCAD.html?download=self">download</a> the portable “single-file” distribution (a standalone `AsciiCAD.html` that runs offline).
