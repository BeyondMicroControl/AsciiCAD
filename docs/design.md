...
In codebase, `glyphToMask` encodes these glyphs into 4 bits, which is the meaningful data we retain about wire glyphs on a grid: `N = 0b0001, E = 0b0010, S = 0b0100, W = 0b1000`.  A glyph’s “line function” is then just a bitwise OR of all the directions it connects.\
Example:
